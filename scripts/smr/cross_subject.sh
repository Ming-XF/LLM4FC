...
#python main.py --model "DFaST" --num_kernels 8 --window_size 3 --data_dir "../data/SMR/SMR128.npy" --num_repeat 5  --dataset 'SMR' --sparsity 0.6 --batch_size 32 --num_epochs 200 --frequency 128 --D 22 --p1 8 --p2 8 --drop_last True --num_heads 4 --distill --num_layers 1 --learning_rate 1e-3 --dropout 0.5 --schedule 'cos' --do_train --do_evaluate --do_test &
