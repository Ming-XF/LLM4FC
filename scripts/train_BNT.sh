...
#
# BNT training script
# Usage: ./scripts/train_BNT.sh <DATASET> <EARLY_STOP_METRIC> <EARLY_STOP_MIN_DELTA>
#
# Examples:
#   ./scripts/train_BNT.sh DiseaseBeirut   AUC   0.001
#   ./scripts/train_BNT.sh GenderDS        AUC   0.001
#   ./scripts/train_BNT.sh AgeTUAB         MAE   0.1
#
