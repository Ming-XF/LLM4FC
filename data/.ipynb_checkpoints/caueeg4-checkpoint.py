...
class CAUEEG4Dataset(BaseDataset):
    def __init__(self, data_config: DataConfig, k=0, train=True, subject_id=0, one_hot=True):
        super(CAUEEG4Dataset, self).__init__(data_config, k, train, subject_id=subject_id, one_hot=one_hot)
...
def caueeg_preprocess(path="../data/CAUEEG/", hz=200):
    ...
    output_path = os.path.join(path, "caueeg4.npz")
